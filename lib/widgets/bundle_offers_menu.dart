    ...
    return Container(
      ...
      child: GetBuilder<CartController>(
          ...
          builder: (value) => Card(
                ...
                elevation: 0,
                child: Padding(
                  padding: const EdgeInsets.only(left: 12, right: 12, bottom: 12, top: 26),
                  child: Column(
                    ...
                    children: [
                      CachedNetworkImage(
                        ...
                        placeholder: (context, url) => SizedBox(height: 100, child: Center(child: CircularProgressIndicator())),
