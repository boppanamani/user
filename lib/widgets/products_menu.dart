  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Card(
          elevation: 0,
          child: Padding(
            padding: const EdgeInsets.only(left: 8, right: 8, bottom: 8, top: 22),
                      ...
                      child: InkWell(
                        onTap: () async {
                          if (global.currentUser.id == null) {
                            ...
                            showOnlyLoaderDialog();
                            await addRemoveWishList(categoryProductList[index].varientId, index);

                            Navigator.pop(context);
                            setState(() {});
                          }
                        },
                        child: categoryProductList[index].isFavourite
                            ? Icon(
                                MdiIcons.heart,
                                size: 20,
                                color: Colors.red,
