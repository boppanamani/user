...
class APIHelper {
  ...
  Future<dynamic> addAddress(Address address) async {
    try {
      ...
      print({'user_id': global.currentUser.id, 'type': address.type, 'receiver_name': address.receiverName, 'receiver_phone': address.receiverPhone, 'city_name': address.city, 'society_name': address.society, 'house_no': address.houseNo, 'landmark': address.landmark, 'state': address.state, 'pin': address.pincode, 'lat': address.lat, 'lng': address.lng});
  ...
  Future<dynamic> checkout({String cartId, String paymentStatus, String paymentMethod, String wallet, String paymentId, String paymentGateway}) async {
    try {
      ...
      print({'cart_id': cartId, 'payment_method': paymentMethod, 'payment_status': paymentStatus, 'wallet': wallet, 'payment_id': paymentId, 'payment_gateway': paymentGateway});
  ...
  Future<dynamic> makeOrder({DateTime selectedDate, String selectedTime}) async {
    try {
      ...
      print({'user_id': global.currentUser.id, 'delivery_date': selectedDate, 'time_slot': selectedTime});
