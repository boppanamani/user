...
class Order {
  ...
  Order.fromJson(Map<String, dynamic> json) {
    try {
      ...
      priceWithoutDelivery = json['price_without_delivery'] != null ? double.parse(json['price_without_delivery'].toString()).round() : null;
      totalProductsMrp = json['total_products_mrp'] != null ? double.parse(json['total_products_mrp'].toString()).round() : null;
      ...
      totalTaxPrice = json['total_tax_price'] != null ? double.parse(json['total_tax_price'].toString()).round() : null;
      orderDate = json['order_date'] != null ? json['order_date'] : '';
      deliveryDate = json['delivery_date'] != null ? json['delivery_date'] : '';
      deliveryCharge = json['delivery_charge'] != null ? double.parse(json['delivery_charge'].toString()).round() : null;
      ...
      couponDiscount = json['coupon_discount'] != null ? double.parse(json['coupon_discount'].toString()).round() : null;
