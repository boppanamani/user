...
class CurrentUser {
  ...
  CurrentUser.fromJson(Map<String, dynamic> json) {
    try {
      ...
      totalSpend = json['total_spent'] != null ? double.parse(json['total_spent'].toString()) : null;
      totalSaved = json['total_save'] != null ? double.parse(json['total_save'].toString()) : null;
    } catch (e) {
