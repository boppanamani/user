...
class DashboardScreen extends BaseRoute {
  ...
  DashboardScreen({a, o, this.onAppDrawerButtonPressed}) : super(a: a, o: o, r: 'DashboardScreen');

  @override
  _DashboardScreenState createState() => _DashboardScreenState(onAppDrawerButtonPressed: onAppDrawerButtonPressed);
}
...
class _DashboardScreenState extends BaseRouteState {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: global.nearStoreModel != null && global.nearStoreModel.id != null && global.currentUser != null && global.currentUser.id != null
            ? SpeedDial(
                icon: Icons.menu,
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      width: 135,
                      child: Text(
                        global.currentLocation != null ? global.currentLocation : '${AppLocalizations.of(context).txt_deliver} No Location',
                    ...
                    children: [
                              ...
                              child: Padding(
                                ...
                                child: global.languageCode == 'en'
                                    ? Marquee(
                                        ...
                                        style: Theme.of(context).textTheme.button.copyWith(fontSize: 13, fontWeight: FontWeight.normal),
                                      )
                                    : Directionality(
                                        textDirection:  TextDirection.ltr,
                                        child: Marquee(
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? Container(
                              ...
                              child: _homeScreenData.banner != null && _homeScreenData.banner != [] && _homeScreenData.banner.length > 0
                                  ? CarouselSlider(
                                      items: _bannerItems(),
                                      carouselController: _carouselController,
                          ...
                          : _bannerShimmer(),
                      _isDataLoaded && _homeScreenData != null
                          ? _homeScreenData.banner != null && _homeScreenData.banner != [] && _homeScreenData.banner.length > 0
                              ? Center(
                                  child: DotsIndicator(
                                    dotsCount: _homeScreenData.banner.length > 0 ? _homeScreenData.banner.length : 1,
                                    ...
                                    return Row(
                                      children: [
                                        ...
                                        SelectCategoryCard(
                                          ...
                                          onPressed: () {
                                            setState(() {
                                              _homeScreenData.topCat.map((e) => e.isSelected = false).toList();
                                              _selectedIndex = index;
                                              if (_selectedIndex == index) {
                                                _homeScreenData.topCat[index].isSelected = true;
                                              }
                                            });
                                            Get.to(() => SubCategoriesScreen(
                                                  a: widget.analytics,
                                                  o: widget.observer,
                                                  screenHeading: _homeScreenData.topCat[index].title,
                                                  categoryId: _homeScreenData.topCat[index].catId,
                                                ));
                                          },
                                          isSelected: _homeScreenData.topCat[index].isSelected,
                                        ),
                                        SizedBox(width: 16),
                                      ],
                                    );
                      ...
                      Padding(
                        ...
                        child: _isDataLoaded && _homeScreenData != null && _homeScreenData.whatsnewProductList != null && _homeScreenData.whatsnewProductList.length > 0
                            ? Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? _homeScreenData.whatsnewProductList != null && _homeScreenData.whatsnewProductList.length > 0
                              ? BundleOffersMenu(
                                  analytics: widget.analytics,
                                  observer: widget.observer,
                                  categoryProductList: _homeScreenData.whatsnewProductList,
                                )
                              : SizedBox()
                          : _shimmer2(),
                      _isDataLoaded && _homeScreenData != null
                          ? Container(
                              ...
                              width: MediaQuery.of(context).size.width,
                              height: MediaQuery.of(context).size.height * 0.15,
                              child: _homeScreenData.secondBanner != null && _homeScreenData.secondBanner != [] && _homeScreenData.secondBanner.length > 0
                                  ? CarouselSlider(
                          ...
                          : _bannerShimmer(),
                      _isDataLoaded && _homeScreenData != null
                          ? _homeScreenData.secondBanner != null && _homeScreenData.secondBanner != [] && _homeScreenData.secondBanner.length > 0
                              ? Center(
                                  child: DotsIndicator(
                                    dotsCount: _homeScreenData.secondBanner.length > 0 ? _homeScreenData.secondBanner.length : 1,
                      ...
                      Padding(
                        ...
                        child: _isDataLoaded && _homeScreenData != null && _homeScreenData.spotLightProductList != null && _homeScreenData.spotLightProductList.length > 0
                            ? Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? _homeScreenData.spotLightProductList != null && _homeScreenData.spotLightProductList.length > 0
                              ? BundleOffersMenu(
                                  analytics: widget.analytics,
                                  observer: widget.observer,
                                  categoryProductList: _homeScreenData.spotLightProductList,
                                )
                              : SizedBox()
                          : _shimmer2(),
                      Padding(
                        ...
                        child: _isDataLoaded && _homeScreenData != null && _homeScreenData.recentSellingProductList != null && _homeScreenData.recentSellingProductList.length > 0
                            ? Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? _homeScreenData.recentSellingProductList != null && _homeScreenData.recentSellingProductList.length > 0
                              ? BundleOffersMenu(
                                  analytics: widget.analytics,
                                  observer: widget.observer,
                                  categoryProductList: _homeScreenData.recentSellingProductList,
                                )
                              : SizedBox()
                          : _shimmer2(),
                      Padding(
                        ...
                        child: _isDataLoaded && _homeScreenData != null && _homeScreenData.topselling != null && _homeScreenData.topselling.length > 0
                            ? Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? _homeScreenData.topselling != null && _homeScreenData.topselling.length > 0
                              ? Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
                                  child: ProductsMenu(
                                    analytics: widget.analytics,
                                    observer: widget.observer,
                                    categoryProductList: _homeScreenData.topselling,
                                  ),
                                )
                              : SizedBox()
                          : _shimmer3(),
    ...
    for (int i = 0; i < _homeScreenData.banner.length; i++) {
      list.add(InkWell(
        ...
        child: CachedNetworkImage(
          imageUrl: global.appInfo.imageUrl + _homeScreenData.banner[i].bannerImage,
  ...
  _getHomeScreenData() async {
    try {
      ...
      print("Exception - dashboard_screen.dart - _getHomeScreenData():" + e.toString());
    }
  }
  ...
  List<Widget> _secondBannerItems() {
    ...
    for (int i = 0; i < _homeScreenData.secondBanner.length; i++) {
      list.add(InkWell(
        ...
        child: CachedNetworkImage(
          imageUrl: global.appInfo.imageUrl + _homeScreenData.secondBanner[i].bannerImage,
          imageBuilder: (context, imageProvider) => Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10),
              image: DecorationImage(image: imageProvider, fit: BoxFit.cover),
