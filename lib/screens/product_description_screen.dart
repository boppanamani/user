...
class AppBarActionButton extends StatefulWidget {
  ...
  @override
  _AppBarActionButtonState createState() => _AppBarActionButtonState(onPressed: onPressed, cartController: cartController);
}
...
class ProductDescriptionScreen extends BaseRoute {
  ...
  ProductDescriptionScreen({a, o, this.productId, this.screenId, this.productDetail}) : super(a: a, o: o, r: 'ProductDescriptionScreen');

  @override
  _ProductDescriptionScreenState createState() => _ProductDescriptionScreenState(productId: productId, screenId: screenId, productDetail: productDetail);
}
...
class _ProductDescriptionScreenState extends BaseRouteState {
  ...
  int _qty = 0;
  int _selectedIndex;
  _ProductDescriptionScreenState({this.productId, this.screenId, this.productDetail});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          _isDataLoaded ? _productDetail.productDetail.productName : '${AppLocalizations.of(context).tle_product_details}',
                  ...
                  children: [
                        ...
                        child: InkWell(
                            onTap: () async {
                              if (global.currentUser.id == null) {
                                ...
                                bool _isAdded = await addRemoveWishList(_productDetail.productDetail.varientId);
                                if (_isAdded) {
                    ...
                    Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          _productDetail.productDetail.images != null && _productDetail.productDetail.images.length > 0
                              ? PhotoViewGallery.builder(
                                  ...
                                  itemCount: _productDetail.productDetail.images.length,
                                  builder: (BuildContext context, int index) {
                                    return PhotoViewGalleryPageOptions(
                                        imageProvider: _productDetail.productDetail.images != null && _productDetail.productDetail.images.length > 0
                                            ? CachedNetworkImageProvider(
                                                global.appInfo.imageUrl + _productDetail.productDetail.images[index].image,
                                              )
                                            : _productDetail.productDetail.productImage != null
                                                ? CachedNetworkImageProvider(
                                                    global.appInfo.imageUrl + _productDetail.productDetail.productImage,
                                                  )
                                                : Container(width: screenWidth, height: 260, child: Image.asset('assets/images/icon.png')));
                                  },
                              ...
                              : PhotoView(
                                  imageProvider: _productDetail.productDetail.productImage != null
                                      ? CachedNetworkImageProvider(
                                          global.appInfo.imageUrl + _productDetail.productDetail.productImage,
                                        )
                                      : Container(width: screenWidth, height: 260, child: Image.asset('assets/images/icon.png')),
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int i) {
                        return Padding(
                          ...
                          child: _productWeightAndQuantity(textTheme, cartController, i),
                        );
                      },
                    ),
                    ...
                    _productDetail.productDetail.tags != null && _productDetail.productDetail.tags.length > 0 ? _subHeading(textTheme, "Tags") : SizedBox(),
                    _productDetail.productDetail.tags != null && _productDetail.productDetail.tags.length > 0 ? _tags(textTheme) : SizedBox(),
                    Padding(
                        ...
                        child: BottomButton(
                            ...
                            onPressed: () {
                              if (global.currentUser.id == null) {
                                ...
                                if (_productDetail.productDetail.stock > 0) {
                                  if (_productDetail.productDetail.varient.where((e) => e.cartQty > 0).toList().length > 0) {
                                    //go to cart
                                    Get.to(() => CartScreen(
                                          a: widget.analytics,
                                          o: widget.observer,
                            ...
                            child: _productDetail.productDetail.stock > 0
                                ? _productDetail.productDetail.varient.where((e) => e.cartQty > 0).toList().length > 0
                                    ? Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text("${AppLocalizations.of(context).btn_go_to_cart}"),
                                          CircleAvatar(
                                            radius: 15,
                                    ...
                                    : Text("${AppLocalizations.of(context).btn_add_cart}")
                                : Text("${AppLocalizations.of(context).txt_out_of_stock}")))
                  ],
                ),
              ),
            )
  ...
  _getBannerProductDetail() async {
    try {
      ...
      print("Exception -  product_description_screen.dart - _getBannerProductDetail():" + e.toString());
    }
  }
  ...
  _getProductDetail() async {
    try {
      ...
      print("Exception -  product_description_screen.dart - _getProductDetail():" + e.toString());
    }
  }
  ...
  _init() async {
    try {
      ...
      print("Exception -  product_description_screen.dart - _init():" + e.toString());
    }
  }
  ...
  Widget _productDescription(TextTheme textTheme) {
    return Padding(
      ...
      child: Text(
        _productDetail.productDetail.description != null && _productDetail.productDetail.description != '' ? _productDetail.productDetail.description : _productDetail.productDetail.type,
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              style: textTheme.caption.copyWith(decoration: TextDecoration.lineThrough),
            ),
          ),
          Spacer(),
          _productDetail.productDetail.stock > 0
              ? _productDetail.productDetail.varient[i].cartQty == null || _productDetail.productDetail.varient[i].cartQty == 0
                  ? InkWell(
                      onTap: () async {
                        if (global.currentUser.id == null) {
                          Get.to(LoginScreen(
                          ...
                          ATCMS isSuccess = await value.addToCart(_productDetail.productDetail, _qty, false, varient: _productDetail.productDetail.varient[i]);
                  ...
                  : Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              if (_productDetail.productDetail.varient[i].cartQty != null && _productDetail.productDetail.varient[i].cartQty == 1) {
                                _qty = 0;
                              } else {
                                _qty = _productDetail.productDetail.varient[i].cartQty - 1;
                              }

                              showOnlyLoaderDialog();
                              ATCMS isSuccess = await value.addToCart(_productDetail.productDetail, _qty, true, varient: _productDetail.productDetail.varient[i]);
                              if (isSuccess.isSuccess != null) {
                                Navigator.of(context).pop();
                              }
                              showToast(isSuccess.message);
                            ...
                            child: Container(
                                ...
                                alignment: Alignment.center,
                                color: Theme.of(context).colorScheme.secondary,
                                child: _productDetail.productDetail.varient != null && _productDetail.productDetail.varient[i].cartQty == 1
                                    ? Icon(
                                        Icons.delete,
                                        size: 17.0,
                                        color: Theme.of(context).primaryColor,
                    ...
                    children: [
                      CachedNetworkImage(
                        ...
                        imageBuilder: (context, imageProvider) => Container(
                          height: 60,
                          width: 60,
                          decoration: BoxDecoration(color: Colors.white, image: DecorationImage(image: imageProvider)),
                        ),
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int i) {
                          return ListTile(
                            ...
                            subtitle: Text('${_productDetail.productDetail.varient[i].quantity} ${_productDetail.productDetail.varient[i].unit} / ${global.appInfo.currencySign} ${_productDetail.productDetail.varient[i].price}', style: Theme.of(context).textTheme.subtitle2.copyWith(fontSize: 15)),
                            trailing: _productDetail.productDetail.varient[i].cartQty == null || _productDetail.productDetail.varient[i].cartQty == 0
                                ? InkWell(
                                    onTap: () async {
                                      if (global.currentUser.id == null) {
                                        Get.to(LoginScreen(
    ...
    for (int i = 0; i < _productDetail.productDetail.tags.length; i++) {
      list.add(Padding(
        ...
        child: MyChip(
          ...
          onPressed: () {
            setState(() {
              _productDetail.productDetail.tags.map((e) => e.isSelected = false).toList();
              _selectedIndex = i;
              if (_selectedIndex == i) {
          ...
          label: _productDetail.productDetail.tags[i].tag != null ? '#${_productDetail.productDetail.tags[i].tag}' : '',
        ),
      ));
    }
    return list;
