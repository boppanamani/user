...
class _ProductRequestScreenState extends BaseRouteState {
  ...
  final Color color = const Color(0xff39c526);
  File tImage;
          ...
          child: Column(
            ...
            children: [
              ...
              global.userProfileController.addressList != null && global.userProfileController.addressList.length > 0
                  ...
                  : InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AddAddressScreen(new Address(), a: widget.analytics, o: widget.observer)));
                      },
                      child: SizedBox(
                          height: 150,
                          child: Center(
