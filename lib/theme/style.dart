...
class ThemeUtils {
  ...
  static ThemeData appTheme() {
    ...
    // Color primaryColor = Color(0xff07b372);
    // Color primaryColor = Color(0xff48bcbb); // 90%
    Color primaryColor = Color(0xff55b589); // 95%
    // Color primaryColor = Color(0xff089d64);

    return ThemeData(
        fontFamily: "Noto-Sans",
        primaryColor: primaryColor,
        colorScheme: ColorScheme.fromSwatch(accentColor: Color(0x2648bcbb)),
